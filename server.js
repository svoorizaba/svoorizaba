...
// Sitio de ejemplo del portafolio: Ferretería Hernández
app.get('/portafolio/ferreteria-hernandez', (req, res) => {
  res.render('clientes/ferreteria-hernandez');
});

// Sitio de ejemplo del portafolio: Sposabella Boutique (plan Página de Aterrizaje)
app.get('/portafolio/sposabella-boutique', (req, res) => {
  res.render('clientes/sposabella-boutique');
});

// Sitio de ejemplo del portafolio: BoneFix Ferretería
app.get('/portafolio/bonefix-ferreteria', (req, res) => {
  res.render('clientes/bonefix-ferreteria');
});

// Sitio de ejemplo del portafolio: GHL Gasolineras (plan Página Empresarial)
app.get('/portafolio/ghl-gasolineras', (req, res) => {
  res.render('clientes/ghl-gasolineras');
});

// Sitio de ejemplo del portafolio: PROSAN Comedores (plan Página Empresarial)
app.get('/portafolio/prosan-comedores', (req, res) => {
  res.render('clientes/prosan-comedores');
});

// Sitio de ejemplo del portafolio: BioAvanza Salud (plan Página Empresarial)
app.get('/portafolio/bioavanza-salud', (req, res) => {
  res.render('clientes/bioavanza-salud');
});
